            ...
            <nav class="navbar navbar-static-top">
                <div class="containers">
                    <div class="navbar-header">
                        <a class="navbar-brand"><b>MED HUB </b>PRO</a>
                        </button>
                    </div>
                    ...
                    <?php $notifikasi = \DB::table('notifikasi')->where('user_id',session('user_id'))->whereRaw("left(created_at,10)='".date('Y-m-d')."'")->orderBy('created_at','desc') ?>
        ...
        <footer class="main-footer">
            <div class="container">
                <div class="pull-right hidden-xs">
                    <b>MED HUB Version</b> 1.0.0
                </div>
                <?php
                $setting = \DB::table('setting')->where('id',1)->first();
                ?>
                <strong>Created By <a href="https://OLE.com">OLE</a></strong> All rights
                reserved.
            </div>
