...
<div class="content-wrapper">
    <section class="content-header">
      <h1>
        Kelola Stock Barang {{$unit_stock['nama_unit'] = isset($unit_stock['nama_unit']) ? $unit_stock['nama_unit'] : ''}}
            ...
            <div class="box">
              ...
              <div class="box-body">
                  ...
                  <button type="button" class="btn btn-primary btn-social btn-flat" data-toggle="modal" data-target="#myModal">
                    <i class="fa fa-file-excel-o" aria-hidden="true"></i> Stock Opname {{ $unit_stock['nama_unit'] = isset($unit_stock['nama_unit']) ? $unit_stock['nama_unit'] : ''}}
                  </button>
                  <a href="/unit-stock/sinkronisasi/{{ $unit_stock['id'] = isset($unit_stock['id']) ? $unit_stock['id'] : ''}}" class="btn btn-info btn-social btn-flat">Sinkronisasi Data</a>
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Stock Opname {{ $unit_stock['nama_unit'] = isset($unit_stock['nama_unit']) ? $unit_stock['nama_unit'] : ''}}</h4>
      </div>
